...
import 'package:whatsapp_messanger/common/widgets/short_h_bar.dart';
import 'package:whatsapp_messanger/feature/auth/pages/image_picker_page.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      floatingActionButton:
          CustomElevatedButton(onPressed: () {}, text: 'NEXT', buttonWidth: 90),
    );
  }
}
